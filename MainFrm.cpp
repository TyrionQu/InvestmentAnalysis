...
bool CMainFrame::SwitchView(CRuntimeClass* targetView)
{
	POSITION posTempl = theApp.GetFirstDocTemplatePosition();
	while (posTempl != NULL) {
		CDocTemplate* pDocTempl = theApp.GetNextDocTemplate(posTempl);
